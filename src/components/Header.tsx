...
const Header = () => {
    ...
    return (
        <div
            className='bg-white text-gray-200 shadow transition border-b-2 border-gray-300 border-solid  w-full h-16 sm:h-32 flex items-center justify-center px-4 fixed z-10'>
            <div
                className='max-w-screen-xl w-screen flex sm:flex-col-reverse sm:w-full sm:h-full sm:justify-evenly items-center justify-center'>
                <div className='flex w-4/5 sm:w-full sm:h-16 sm:h-full sm:flex sm: items-center justify-evenly'>
                    ...
                    <div
                        className={`bg-gray-100 p-1 border-2 border-solid border-gray-600 rounded-md w-1/2 mx-2 flex sm:h-3/4 sm:items-center sm:justify-center  md:w-80`}>
                        <input
                            value={searchTerm}
                    ...
                    <div className="flex">
                        {
                            true ? (
                                ...
                                <>
                                    <Link to="/cart">
                                        <div
                                            className="h-full w-14 flex items-center justify-center  mx-2 rounded-md hover:cursor-pointer">
                                            <GrCart color="black" size={24}/>
                                            {
                                                cart.length !== 0 && (
                                                    <MDBBadge
                                                        className="absolute mb-4 px-2 bg-indigo-500 rounded-2xl text-sm ml-8"
                                                        color='danger' notification pill>{cart.length}</MDBBadge>
                                                )
                                            }
